...
public class OrderQueryRepository {
   ...
   private Map<Long,List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds){
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery(
                        "select new jpabook_jinu.jpashop_jinu.repository.order.query.OrderFlatDto(o.id,m.name,o.orderDate,o.orderStatus,d.address,i.name,oi.orderPrice,oi.count)"+
                        " from Order o"+
                                " join o.member m"+
                                " join o.delivery d"+
